...
<html>
          ...
          <div class="bank-options">
            <div class="frame-parent62">
              ...
              <div class="component-1-container">
                <button class="CircleButton" data-placeholder="Bank Details" onclick="changeColor(event,!1)"></button>
              </div>
            </div>
            <div class="frame-parent66">
              ...
              <div class="component-3-container">
                <button class="CircleButton" data-placeholder="QRIS Details" onclick="changeColor(event,!0)"></button>
              </div>
            </div>
          </div>
          <div class="container8">
            <div class="container9">
              <div class="voice-call-container">
                <div class="voice-call2">Paket Ultimate</div>
                <div class="subtotal-total-container">
                  <div class="subtotal-total-labels-parent">
                    ...
                    <div class="subtotal-total-labels1">
                      <div class="rp-2000004">Rp 350.000</div>
                      <b class="rp-2000005">Rp 350.000</b>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <form class="container11">
                  <div class="input-fields-container">
                    <div class="input-fields-labels1">
                      <select id="bankNameDropdown" class="form-control" oninput="checkForm()" disabled>
                    ...
                    <div class="input-fields-labels2">
                      <input id="input2" class="e-wallet-details3" placeholder="Rincian" type="text" oninput="checkForm()" readonly="readonly">
                    </div>
                  </div>
  ...
  if (isQRIS) {
    generateQRCode('https://www.canva.com/design/DAGHvQfuL3U/x_HNzdmfN8wGnGBaFfMdeg/view?utm_content=DAGHvQfuL3U&utm_campaign=designshare&utm_medium=link&utm_source=editor');
